    ...
    <ScrollView style={{flex: 1, backgroundColor: "white"}}>
      ...
      <View style={{display: "flex", justifyContent: "center", alignItems: "center", padding: 10, width: "100%"}}>
        <View style={{width: "100%", display: "flex", justifyContent: "center", alignItems: "center", flexDirection: 'row'}}>
          <TextInput value={searchQuery} onChangeText={setSearchQuery} style={{height: 40, flex: 1, borderBottomLeftRadius: 5, borderTopLeftRadius: 5, padding: 10, borderColor: "#e7e7e7", borderWidth: 1}} placeholder="Search Courses..." />
          <TouchableHighlight onPress={handlePress} underlayColor={"unset"}>
