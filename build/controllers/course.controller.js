...
exports.uploadVideo = exports.generateVideoUrl = exports.deleteCourse = exports.getAdminAllCourses = exports.addReplyToReview = exports.addReview = exports.addAnwser = exports.addQuestion = exports.getCourseByUser = exports.getAllCourses = exports.getSingleCourse = exports.editCourse = exports.uploadCourse = void 0;
...
//upload vide
exports.uploadVideo = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        const { title, folderId, url } = req.body;
        const response = await axios_1.default.put('https://dev.vdocipher.com/api/videos/importUrl', {
            url: url,
            title: 'text',
